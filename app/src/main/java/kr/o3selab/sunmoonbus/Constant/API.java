...
public class API {
    ...
    // 평일 그룹
    static NetworkGroup[] WEEKDAY_NOHOLIDAY = {
    ...
    // 토요일/공휴일 그룹
    static NetworkGroup[] SATURDAY_NOHOLIDAY = {
    ...
    // 일요일 그룹
    static NetworkGroup[] SUNDAY_NOHOLIDAY = {
    ...
    // 평일 그룹
    static final NetworkGroup[] WEEKDAY_HOLIDAY = {
    ...
    // 휴일 그룹
    static final NetworkGroup[] SATURDAY_HOLIDAY = {
            WEEKEND_HOLIDAY_CHEONAN_ASAN_STATION,
            WEEKEND_HOLIDAY_CHEONAN_TERMINAL
    };

    static String getHolidayUrl() {
        return WEEKDAY_HOLIDAY_CHEONAN_TERMINAL_URL;
    }

    static TimeTableData getData(NetworkGroup networkGroup) {
